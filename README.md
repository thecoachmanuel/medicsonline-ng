...
Full-stack healthcare web application where **patients can search and consult doctors**, **doctors can manage their profiles and availability**, and **clinics can register** to offer services. Built using the MERN stack with  features like Google OAuth, Cloudinary image uploads, real-time scheduling, and smart filtering.
...
*  **Doctor Profile Management**
  ...
  * Cloudinary-powered profile photo and gallery upload.
