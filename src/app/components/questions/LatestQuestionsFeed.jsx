...
const LatestQuestionsFeed = () => {
  ...
  useEffect(() => {
    const fetchLatestQuestions = async () => {
      try {
        const res = await fetch(`${API_BASE_URL}/api/question/answered-latest?limit=5`);
                ...
                return a.doctor ? (
                  <div className="mt-4" key={idx}>
                    ...
                    <div className="text-sm flex items-start gap-4 mt-2">
                      <Link href={`/profile-info/${a.doctor._id}`} className="flex-shrink-0">
                        <img
                      ...
                      <div className="flex flex-col  leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                        <Link href={`/profile-info/${a.doctor._id}`} >
