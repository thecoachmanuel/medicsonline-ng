...
function PatientAccount() {
  ...
  useEffect(() => {
    if (currentUser) setActiveSection('account-settings')
  }, [currentUser])

  useEffect(() => {
    if (location.state?.section === "my-visits") setActiveSection("my-visits");
  }, [location])
      ...
      <div className='bg-gray-200 min-h-dvh'>
        <main className='sm:w-[80%] m-auto bg-gray-200'>
          <section className='sm:flex '>
            {/* Sidebar */}
            <aside className='bg-gray-200 sm:w-[20%] w-[90%] m-auto sm:fixed p-4 lg:mt-6 sm:left-0 sm:top-24 sm:h-full shadow-mdoverflow-auto'>
              <nav>
                <ul>
                          ...
                          <Modal.Body>
                            <div className='text-center'>
                              ...
                              <div className='flex justify-center gap-4'>
                                <Button color='failure' onClick={handleDeleteUser}>Delete account</Button>
