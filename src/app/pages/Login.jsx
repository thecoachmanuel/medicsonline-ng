    ...
    try {
      ...
      if (response.ok) {
        ...
        if (user.role === 'admin') {
          ...
          const isCrossRolePath = forbiddenPaths.some(path => redirectUrl?.startsWith(path))

          router.push(isCrossRolePath ? redirectTo || '/' : redirectUrl || redirectTo || '/')
          ...
          <div className=' m-auto w-full sm:w-[60%]'>
            <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
              ...
              <div className='text-[11px] text-center'>
                <Link href='/forgot-password'><span className='text-blue-500 mr-1'>Forgot your password ?</span></Link>
              </div>
            </form>
            <hr className='mt-5'/>
