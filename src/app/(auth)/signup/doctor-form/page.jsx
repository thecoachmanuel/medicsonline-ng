...
const DoctorSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      setErrorMessage(null);
      const response = await fetch(`${API_BASE_URL}/api/auth/signup/doctor`, {
        method: 'POST',
        headers: {
        ...
        <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-6'>
          <div className='m-auto w-full sm:w-[60%]'>
            <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
              <h2 style={headerStyle}>Create a free doctor account</h2>

              <div className='flex justify-center items-center py-6'>
                <hr className='w-32 mr-2' />
                <span className='px-6'>Doctor Registration</span>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
                  ...
                  <input 
                    ...
                    className={`block w-full mt-1 placeholder-gray-400 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-300 focus:ring-gray-300 hover:border-gray-400 transition duration-300 ease-in-out ${isFieldInvalid('firstName') ? 'border-red-500' : 'border-gray-300'}`}
                  />
                </div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className={`block w-full mt-1 placeholder-gray-400 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-300 focus:ring-gray-300 hover:border-gray-400 transition duration-300 ease-in-out ${isFieldInvalid('lastName') ? 'border-red-500' : 'border-gray-300'}`}
                  />
                </div>
              </div>
